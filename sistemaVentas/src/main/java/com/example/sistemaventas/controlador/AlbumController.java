...
public class AlbumController implements Initializable {
        ...
        @FXML
        public TableColumn<Album, Double> colPrecioAlbum;
        @FXML
        ...
        public void initialize(URL url, ResourceBundle resourceBundle) {
            listarAlbumes();
            listarGeneros();
            colPrecioAlbum.setCellFactory(column -> {
                return new TableCell<Album, Double>() {
                    @Override
        ...
        public void listarAlbumes() {
            ...
            colArtistaAlbum.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getArtistaAlbum()));
            colPrecioAlbum.setCellValueFactory(cellData -> new SimpleObjectProperty<>(cellData.getValue().getPrecioAlbum()));
