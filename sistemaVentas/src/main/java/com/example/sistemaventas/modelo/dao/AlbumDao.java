...
public class AlbumDao {
        ...
        public void creaTablaAlbum() {
            String sqlTablaAlbum = "create table if not exists album( id integer primary key, codigo text,nombre text, artista text,fecha_creacion DATE, id_genero int , precio real)";
