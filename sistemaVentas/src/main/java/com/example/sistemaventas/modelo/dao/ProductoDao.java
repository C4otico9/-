...
public class ProductoDao {
    ...
    public void creaTablaProducto() {
        String sqlTablaProducto = "create table if not exists producto( id integer primary key, codigo text,nombre text, descripcion text,fecha_creacion DATE, id_categoria int , precio real)";
